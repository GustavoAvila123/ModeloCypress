...
describe ('COMUNICADOS', () => {
    ...
    it('3.2 - REALIZAR UPLOAD DE IMAGEM DE CAPA COM TAMANHO SUPERIOR A 2MB E VERIFICAR AS DIMENSÕES MÍNIMAS RECOMENDADAS PARA A IMAGEM DE CAPA', () => {
    ...
    it('3.3 - INSERIR UM TÍTULO DO COMUNICADO COM MAIS DE 100 CARACTERES E VERIFICAR MENSAGEM DE ERRO, ALÉM DE VALIDAR A CONTAGEM DE CARACTERES VISÍVEL NO CAMPO DE CONTEÚDO DO COMUNICADO', () => {
        Metodos.clicar(elementosComunicados.botaoExpandir)
    ...
    it('3.4 -  INSERIR CONTEÚDO DO COMUNICADO COM MAIS DE 2000 CARACTERES E VERIFICAR MENSAGEM DE ERRO', () => {
        Metodos.clicar(elementosComunicados.botaoExpandir)
    ...
    it('3.5 - REALIZAR MÚLTIPLOS UPLOADS DE ANEXOS E VERIFICAR SE TODOS SÃO REGISTRADOS CORRETAMENTE', () => {
        Metodos.clicar(elementosComunicados.botaoExpandir)
    ...
    it('3.6 - TENTAR ANEXAR ARQUIVOS COM FORMATOS INVÁLIDOS E VERIFICAR MENSAGENS DE ERRO', () => {
        Metodos.clicar(elementosComunicados.botaoExpandir)
